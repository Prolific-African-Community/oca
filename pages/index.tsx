...
const faculties = [
  {
    ...
    desc: 'Finance, comptabilité, management et économie appliquée.',
  },
  {
    title: 'Technologie & Data',
    desc: 'Développement logiciel, intelligence artificielle et data science.',
  },
  {
    title: 'Droit & Gouvernance',
    desc: 'Droit des affaires, régulation, conformité et gouvernance.',
  },
  {
    title: 'Entrepreneuriat & Innovation',
    desc: 'Création d’entreprise, innovation stratégique et incubation.',
  },
]
...
export default function OCAHome() {
  ...
  return (
    <>
      <Head>
        <title>
          Open Campus Africa — Le campus numérique de l’excellence africaine
        </title>
        <meta
          name="description"
      ...
      <div className="min-h-screen bg-page text-ink">
            ...
            <div className="animate-fade-up">
              ...
              <h1 className="mt-7 text-[44px] font-medium leading-[1.03] tracking-tightest text-ink sm:text-6xl lg:text-[66px]">
                ...
                <span
                  ...
                  style={{
                    backgroundImage: 'linear-gradient(100deg,#0A2A6B,#0071E3)',
                  }}
                >
                  Structurer l’avenir.
                </span>
              ...
              <p className="text-ink/55 mt-7 max-w-xl text-lg leading-relaxed">
                Cours, sessions live, crédits ECTS et certificats — réunis dans
                une plateforme académique claire, structurée et conforme aux
                standards régionaux.
              </p>
              ...
              <div className="text-ink/45 mt-10 flex flex-wrap items-center gap-x-7 gap-y-3 text-sm">
                <span className="inline-flex items-center gap-2">
                  <ShieldIcon size={17} className="text-oca/70" /> Conforme LMD
                </span>
                <span className="inline-flex items-center gap-2">
                  <LayersIcon size={17} className="text-oca/70" /> Crédits ECTS
                </span>
                <span className="inline-flex items-center gap-2">
                  <GlobeIcon size={17} className="text-oca/70" />{' '}
                  Multi-universités
                </span>
              </div>
            </div>
        ...
        <section id="vision" className="scroll-mt-24 px-6 py-28">
          <Reveal className="mx-auto max-w-4xl text-center">
            <p className="text-sm font-medium uppercase tracking-[0.16em] text-oca/70">
              Notre conviction
            </p>
            <p className="mt-6 text-3xl font-medium leading-[1.25] tracking-tightest text-ink sm:text-[40px] sm:leading-[1.2]">
              Nous ne construisons pas un logiciel de gestion. Nous construisons
              le{' '}
              <span
                className="bg-clip-text text-transparent"
                style={{
          ...
          <div className="mx-auto max-w-6xl">
            <Reveal>
              <SectionHeading
                ...
                title="Tout le parcours académique, réuni"
              />
            </Reveal>
        ...
        <section className="px-6 py-16">
          <div className="mx-auto max-w-6xl">
            <Reveal>
              <SectionHeading
                eyebrow="Le flux"
                title="De la connexion au diplôme"
              />
            </Reveal>
            <div className="relative mt-14">
              <div
                ...
                style={{
                  background:
                    'linear-gradient(90deg,transparent,#C9D6EE 12%,#C9D6EE 88%,transparent)',
                }}
              />
              ...
              {faculties.map((f, i) => (
                <Reveal key={f.title} delay={i * 80}>
                  <div className="group flex items-start gap-5 rounded-hero border border-hairline bg-white p-7 shadow-soft transition-all duration-500 hover:-translate-y-1 hover:shadow-lift">
                    ...
                    <div>
                      <h3 className="text-lg font-medium tracking-tightest text-ink">
                        {f.title}
                      </h3>
                      <p className="text-ink/55 mt-2 leading-relaxed">
                        {f.desc}
                      </p>
                    </div>
                  </div>
        ...
        <section id="contact" className="scroll-mt-24 px-6 py-16">
          <Reveal className="mx-auto max-w-6xl">
            <DarkCanvas
              className="rounded-hero px-8 py-16 sm:px-14 sm:py-20"
              showOrbits={false}
            >
              <div className="relative grid gap-12 lg:grid-cols-2 lg:items-center">
                <div>
                  ...
                  <p className="mt-5 max-w-md text-lg leading-relaxed text-white/60">
                    Intégrez vos étudiants, administrez vos cohortes et déployez
                    des programmes structurés au sein d’une plateforme complète.
                  </p>
                  <div className="mt-8 flex flex-wrap gap-3">
                    <Link
                      ...
                      className={buttonClasses(
                        'primary',
                        'lg',
                        'bg-white text-oca hover:bg-white/90'
                      )}
                    >
                      Accéder à mon espace
                    </Link>
                ...
                <form className="border-white/12 relative space-y-4 rounded-hero border bg-white/[0.06] p-7 backdrop-blur-md">
                  ...
                  <Field label="Message">
                    <textarea
                      rows={3}
                      className={cn(darkField, 'resize-none py-3')}
                  ...
                  <Button
                    type="submit"
                    size="lg"
                    className="w-full bg-white text-oca hover:bg-white/90"
                  >
                    Envoyer le message
                  </Button>
                </form>
...
function SectionHeading({
  ...
  return (
    <div className={centered ? 'text-center' : ''}>
      <p className="text-sm font-medium uppercase tracking-[0.14em] text-oca/70">
        {eyebrow}
      </p>
      <h2 className="mt-3 text-3xl font-medium tracking-tightest text-ink sm:text-[40px]">
        {title}
      </h2>
    </div>
  )
  ...
  return (
    <div className="group relative h-full overflow-hidden rounded-hero border border-hairline bg-white p-7 shadow-soft transition-all duration-500 hover:-translate-y-1.5 hover:shadow-lift">
      <div
        ...
        style={{
          background:
            'radial-gradient(80% 100% at 50% 0%, rgba(0,113,227,0.10), transparent)',
        }}
      />
      ...
      <h3 className="relative mt-5 text-lg font-medium tracking-tightest text-ink">
        {title}
      </h3>
      <p className="text-ink/55 relative mt-2 text-[15px] leading-relaxed">
        {desc}
      </p>
    </div>
  )
