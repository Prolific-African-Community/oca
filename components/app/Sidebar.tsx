...
export function Sidebar({ nav, home, onLogout }: SidebarProps) {
  ...
  return (
    <aside
      className="group bg-white/85 fixed inset-y-3 left-3 z-40 hidden w-[76px] flex-col overflow-hidden rounded-hero border border-hairline shadow-soft backdrop-blur-xl transition-[width] duration-300 ease-out hover:w-[252px] md:flex"
      aria-label="Navigation principale"
    >
      {/* brand */}
      <div className="flex h-[68px] items-center px-[18px]">
        <Link href={home} aria-label="Accueil" className="flex items-center">
