...
export function MobileNav({ nav, home }: { nav: NavItem[]; home: string }) {
  ...
  return (
    <nav
      className="fixed inset-x-4 bottom-4 z-40 flex items-center justify-around rounded-full border border-hairline bg-white/85 px-2 py-1.5 shadow-lift backdrop-blur-xl md:hidden"
